...
const pt: Dictionary = {
  ...
  about: {
    ...
    back: 'Voltar',
    version: 'VERSÃO DO SISTEMA: 2.6.4',
    description:
    ...
    sections: {
      dev: {
        label: '> DESENVOLVEDOR',
        content:
          'Projetado por Eduardo Nakamura como um estudo de interfaces retro-futuristas utilizando React e Tailwind CSS v4.'
      },
      tech: {
        label: '> ESPECIFICAÇÕES TÉCNICAS',
        content:
          'Engine: React + Vite | Estilização: Tailwind CSS | Tipografia: Share Tech Mono.'
      },
      legal: {
        label: '> AVISO LEGAL',
        content:
          'Este é um projeto de fã, sem fins lucrativos. Fallout e elementos relacionados são marcas registradas da Bethesda Softworks.'
      }
    },
    footerNote: 'BOA SORTE NA TERRA DEVASTADA.'
  },
  ...
  reign: {
    ...
    itemDescriptions: {
      ...
      drinking_flask_plus:
        'O frasco agora brilha com uma aura sagrada e água purificada.',
    ...
    events: {
      ...
      wizardRefine:
        'O Mago transmuta sua Gema Bruta em uma GEMA REFINADA e um FRAGMENTO MÁGICO!',
    ...
    commands: {
      ...
      langChangePrompt:
        '> AVISO: Mudar o idioma reiniciará o jogo. Continuar? (S/N)',
